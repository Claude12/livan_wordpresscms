<?php
/**
 * livan functions and definitions
 *
 ...
 */
function livan_setup()
{
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on livan, use a find and replace
	 * to change 'livan' to the name of your theme in all the template files.
	 */
	load_theme_textdomain('livan', get_template_directory() . '/languages');
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__('Primary', 'livan'),
			'menu-2' => esc_html__('Footer', 'livan'),
		)
	);
...
add_action('after_setup_theme', 'livan_setup');
 ...
 */
function livan_content_width()
{
	$GLOBALS['content_width'] = apply_filters('livan_content_width', 640);
}
add_action('after_setup_theme', 'livan_content_width', 0);
 ...
 */
function livan_widgets_init()
{
	register_sidebar(
		array(
			'name' => esc_html__('Sidebar', 'livan'),
			'id' => 'sidebar-1',
			'description' => esc_html__('Add widgets here.', 'livan'),
...
add_action('widgets_init', 'livan_widgets_init');
