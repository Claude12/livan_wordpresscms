                        ...
                        <div class="service-block__item">
                            ...
                            <?php if ($service_link && isset($service_link['url'])): ?>
                                <div class="service-block__item-cta">
                                    <svg width="56px" height="56px" viewBox="0 0 20 20" version="1.1"
                                        xmlns="http://www.w3.org/2000/svg" fill="#00bea3" stroke="#00bea3">
                                        ...
                                        <g id="SVGRepo_iconCarrier">
                                            <g id="layer1">
                                                <path
                                                    ...
                                                    style="fill:#00bea3; fill-opacity:1;  stroke-width:0.0002;" />
                                            </g>
                                        </g>
